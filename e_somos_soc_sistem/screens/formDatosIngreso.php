    ...
    <div class="card-body">
        <form id="formSocIn">
            <div class="form-group row">
                <label for="inpKmIn" class="col-3 col-lg-3 col-form-label text-right">KM ODO</label>
                ...
                <div class="col-9 col-lg-9" style="display: none;">
                    <input id="inpNumBusIn" name="inpNumBusIn" type="text">
                </div>
            </div>
            <div class="form-group row">
                <label for="inpSocIn" class="col-3 col-lg-3 col-form-label text-right">SOC In</label>
                <div class="input-group input-group-sm col-9 col-lg-9 mb-3">
            ...
            <div class="form-group row">
                <label for="inpElectLineIn" class="col-3 col-lg-3 col-form-label text-right">N° Electrolinea</label>
                <div class="col-9 col-lg-9">
